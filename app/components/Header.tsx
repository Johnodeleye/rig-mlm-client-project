        ...
        <div className="hidden lg:block flex-1 max-w-xl mx-8">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-2.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all bg-gray-50 hover:bg-white text-sm"
            />
          </div>
        </div>
            ...
            >
              <div className="relative">
                {userProfile?.profilePicture ? (
                  <div className="w-9 h-9 rounded-xl overflow-hidden border-2 border-gray-200 group-hover:border-blue-500 transition-colors">
                    <img 
                  ...
                  <div className="w-9 h-9 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center border-2 border-gray-200 group-hover:border-blue-500 transition-colors">
