...
const MobileSidebar = ({ 
  ...
  const menuItems = [
    { id: 'dashboard', label: 'Dashboard', icon: Home, href: '/home', color: 'from-blue-500 to-blue-600' },
    { id: 'referrals', label: 'My Referrals', icon: Users, href: '/referrals', color: 'from-purple-500 to-purple-600' },
    { id: 'my teams', label: 'My Teams', icon: PersonStanding, href: '/teams', color: 'from-indigo-500 to-indigo-600' },
    { id: 'earnings', label: 'Wallet', icon: Wallet, href: '/wallet', color: 'from-green-500 to-green-600' },
    { id: 'send', label: 'Send Money', icon: Send, href: '/send', color: 'from-cyan-500 to-cyan-600' },
    { id: 'withdraw', label: 'Withdraw', icon: CreditCard, href: '/withdraw', color: 'from-orange-500 to-orange-600' },
      ...
      {isSidebarOpen && (
        <>
          ...
          >
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-700 px-5 py-6">
              ...
              <div className="absolute top-1/2 right-0 w-24 h-24 bg-purple-400/20 rounded-full blur-xl"></div>
              ...
              <div className="relative z-10">
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-gradient-to-br from-blue-500/30 to-blue-600/30 backdrop-blur-sm rounded-xl px-3 py-2 border border-white/30">
                      <div className="flex items-center gap-1 mb-0.5">
                        <TrendingUp className="w-3 h-3 text-blue-100" />
                        <span className="text-[10px] text-blue-100 font-medium">PV Points</span>
                      </div>
                      <span className="text-lg font-bold text-white block">{userProfile?.pv || 0}</span>
                    </div>
                    <div className="bg-gradient-to-br from-purple-500/30 to-purple-600/30 backdrop-blur-sm rounded-xl px-3 py-2 border border-white/30">
                      <div className="flex items-center gap-1 mb-0.5">
                        <Sparkles className="w-3 h-3 text-purple-100" />
                        <span className="text-[10px] text-purple-100 font-medium">TP Points</span>
                      </div>
