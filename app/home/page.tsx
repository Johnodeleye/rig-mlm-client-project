...
const Dashboard = () => {
  ...
  const commissionData = [
    { level: 1, totalMembers: 3, commission: '48%', earnedAmount: '₦1,200' },
    { level: 2, totalMembers: 2, commission: '10%', earnedAmount: '₦250' },
    { level: 3, totalMembers: 1, commission: '5%', earnedAmount: '₦125' },
    { level: 4, totalMembers: 0, commission: '3%', earnedAmount: '₦0' },
    { level: 5, totalMembers: 0, commission: '2%', earnedAmount: '₦0' }
  ];
                ...
                <table className="w-full min-w-[280px]">
                  <thead>
                    <tr className="border-b border-gray-200">
                      ...
                      <th className="text-left py-2 lg:py-3 text-xs lg:text-sm font-medium text-gray-600">Earned</th>
                    </tr>
                  </thead>
                  <tbody>
                    {commissionData.map((row, index) => (
                      <tr key={index} className="border-b border-gray-100 last:border-0">
                        ...
                        <td className="py-2 lg:py-3 text-xs lg:text-sm font-medium text-gray-900">{row.earnedAmount}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
